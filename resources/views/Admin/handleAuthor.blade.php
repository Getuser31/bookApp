    ...
    <div class="container">
        ...
        <table>
            ...
            @foreach($authors as $author)
                <tr>
                    <th>{{$author->name}}</th>
                    <th><a href="{{route("admin.author.edit", $author->id)}}">
        ...
        <a href="{{route("admin.author.create")}}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">New Author</a>
    </div>
